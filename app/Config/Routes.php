...
$routes->group('client/inspecciones', ['filter' => 'auth'], function($routes) {
    ...
    $routes->get('productos-quimicos', 'ClientInspeccionesController::listProductosQuimicos');
    $routes->get('productos-quimicos/(:num)', 'ClientInspeccionesController::viewProductosQuimicos/$1');
    ...
    $routes->get('brigada-simulacros', 'ClientInspeccionesController::listBrigadaSimulacros');
    $routes->get('brigada-simulacros/(:num)', 'ClientInspeccionesController::viewBrigadaSimulacros/$1');
    $routes->get('ascensores', 'ClientInspeccionesController::listAscensores');
    $routes->get('ascensores/(:num)', 'ClientInspeccionesController::viewAscensores/$1');
    $routes->get('piscinas', 'ClientInspeccionesController::listPiscinas');
    $routes->get('piscinas/(:num)', 'ClientInspeccionesController::viewPiscinas/$1');
    $routes->get('piscinero', 'ClientInspeccionesController::listPiscinero');
    $routes->get('piscinero/(:num)', 'ClientInspeccionesController::viewPiscinero/$1');
    ...
    $routes->get('evaluacion-capacitacion', 'ClientInspeccionesController::listEvaluacionCapacitacion');
    $routes->get('evaluacion-capacitacion/(:num)', 'ClientInspeccionesController::viewEvaluacionCapacitacion/$1');
    ...
    $routes->get('contingencia-plagas', 'ClientInspeccionesController::listContingenciaPlagas');
    $routes->get('contingencia-plagas/(:num)', 'ClientInspeccionesController::viewContingenciaPlagas/$1');
    $routes->get('contingencia-limpieza-desinfeccion', 'ClientInspeccionesController::listContingenciaLimpieza');
    $routes->get('contingencia-limpieza-desinfeccion/(:num)', 'ClientInspeccionesController::viewContingenciaLimpieza/$1');
    $routes->get('contingencia-agua', 'ClientInspeccionesController::listContingenciaAgua');
    $routes->get('contingencia-agua/(:num)', 'ClientInspeccionesController::viewContingenciaAgua/$1');
    $routes->get('contingencia-basura', 'ClientInspeccionesController::listContingenciaBasura');
    $routes->get('contingencia-basura/(:num)', 'ClientInspeccionesController::viewContingenciaBasura/$1');
    $routes->get('lavado-tanques', 'ClientInspeccionesController::listLavadoTanques');
    $routes->get('lavado-tanques/(:num)', 'ClientInspeccionesController::viewLavadoTanques/$1');
    $routes->get('fumigacion', 'ClientInspeccionesController::listFumigacion');
    $routes->get('fumigacion/(:num)', 'ClientInspeccionesController::viewFumigacion/$1');
    $routes->get('desratizacion', 'ClientInspeccionesController::listDesratizacion');
    $routes->get('desratizacion/(:num)', 'ClientInspeccionesController::viewDesratizacion/$1');
    $routes->get('planilla-ss', 'ClientInspeccionesController::listPlanillaSS');
    $routes->get('planilla-ss/(:num)', 'ClientInspeccionesController::viewPlanillaSS/$1');
...
$routes->group('inspecciones', ['namespace' => 'App\Controllers\Inspecciones', 'filter' => 'auth'], function($routes) {
    ...
    $routes->post('matriz/no-aplica-masivo', 'MatrizInspeccionesController::marcarNoAplicaMasivo');
    ...
    $routes->get('acta-visita/api-inspecciones-contexto/(:num)', 'ActaVisitaController::apiInspeccionesContexto/$1');
    ...
    $routes->get('acta-capacitacion/api-evaluaciones-del-dia',     'ActaCapacitacionController::apiEvaluacionesDelDia');
