...
<body>
            ...
            <div class="table-container">
                ...
                <?php if (!empty($$key)) : ?>
                    <div class="table-responsive">
                        <table id="<?= esc($key) ?>" class="table table-hover table-striped dt-responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Título</th>
                                    <th>Enlace</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Lista de IDs de tablas según las secciones
            var tableIds = [
                'inspecciones', 'reportes', 'aseo', 'vigilancia', 'ambiental', 'actasdevisita',
                'capacitaciones', 'cincuentahoras', 'reporteministerio', 'cierredemes',
                'emergencias', 'otrosproveedores', 'secretariasalud', 'lavadotanques',
                'localescomerciales', 'fumigaciones', 'normatividad', 'contrato'
            ];

            // Inicializar DataTables para cada tabla
            tableIds.forEach(function(id) {
                // Verificar si la tabla existe en el DOM antes de inicializar DataTable
                if ($('#' + id).length) {
                    $('#' + id).DataTable({
                        responsive: true,
                        dom: 'Bfrtip',
