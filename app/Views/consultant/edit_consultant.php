                ...
                <form action="<?= base_url('/editConsultantPost/' . $consultant['id_consultor']) ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($consultant['foto_consultor'])): ?>
                            <div class="mt-2">
                                <img src="<?= base_url('uploads/firmas_consultores/' . $consultant['foto_consultor']) ?>" alt="Foto del Consultor" class="img-thumbnail" width="100">
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($consultant['firma_consultor'])): ?>
                            <div class="mt-2">
                                <img src="<?= base_url('uploads/firmas_consultores/' . $consultant['firma_consultor']) ?>" alt="Firma del Consultor" class="img-thumbnail" width="100">
                            </div>
                        <?php endif; ?>
                    </div>
