...
<body>
    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-messages" id="chatMessages">
            <div class="welcome-message" id="welcomeMessage">
                <div class="icon-circle" style="background:#1d2638; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
    ...
    <script>
        ...
        const USER_PHOTO = '<?= !empty($usuario['foto']) ? base_url('uploads/firmas_consultores/' . $usuario['foto']) : '' ?>';
        ...
        function appendMessage(role, content, toolsUsed = [], confirmType = null) {
            ...
            if (role === 'user') {
                ...
                avatar.innerHTML = '<img src="' + BASE_URL + 'otto/otto.png?v=2" alt="Otto">';
            }
