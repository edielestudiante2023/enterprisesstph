  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      var table = $('#actividadesTable').DataTable({
        ...
        order: [[8, 'asc']], // Ordenar por Fecha Propuesta (índice 8)
        ajax: {
          url: tableAjaxUrl,
          dataSrc: 'data'
        },
      ...
      $('#actividadesTable tbody').on('click', 'span.editable-date', function(){
        ...
        if(cell.find('input').length === 0){
          ...
          var input = $('<input>', { type: 'date', value: currentValue, class: 'form-control form-control-sm' });
          cell.html(input);
          input.focus();
