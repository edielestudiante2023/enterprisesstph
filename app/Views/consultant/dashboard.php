...
<head>
  ...
  <style>
    ...
    /* Estilos para filas según la columna "Orden"
       Se aplica a cada celda para mayor especificidad */
    tr.orden-1 > td {
      background-color: #FFEBEE !important; /* pastel rojo muy suave */
    }

    tr.orden-2 > td {
      background-color: #E8F5E9 !important; /* pastel verde */
    }

    tr.orden-3 > td {
      background-color: #E3F2FD !important; /* pastel azul */
    }

    tr.orden-4 > td {
      background-color: #FFFDE7 !important; /* pastel amarillo */
    }

    tr.orden-5 > td {
      background-color: #F3E5F5 !important; /* pastel morado suave */
    }
  </style>
</head>
    ...
    $(document).ready(function () {
      $('#itemTable').DataTable({
        ...
        rowCallback: function (row, data, index) {
          // Usamos find para obtener el texto de la celda de la columna "Orden"
          var orden = $.trim($(row).find('td:eq(5)').text());
          // Descomenta la siguiente línea para depurar en la consola:
          // console.log("Fila " + index + " - Orden:", orden);
          if (orden === '1') {
