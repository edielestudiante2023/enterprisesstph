...
document.addEventListener('DOMContentLoaded',function(){
    ...
    $('#tablaInsp').on('click','.btn-del',function(){
        ...
        Swal.fire({title:'¿Eliminar reporte?',html:'Se eliminará el reporte de <strong>'+n+'</strong>',icon:'warning',showCancelButton:true,confirmButtonColor:'#dc3545',confirmButtonText:'Sí, eliminar',cancelButtonText:'Cancelar'})
