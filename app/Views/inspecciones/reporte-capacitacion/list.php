<div class="container-fluid px-3">
    ...
    <?php if (empty($inspecciones)): ?>
        <div class="text-center text-muted py-4">
            <i class="fas fa-chalkboard-teacher" style="font-size:40px; opacity:0.3;"></i>
            <p class="mt-2">No hay reportes de capacitacion</p>
        </div>
    <?php else: ?>
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div style="flex:1;">
                        ...
                        <div class="text-muted" style="font-size:12px;">
                            <?= date('d/m/Y', strtotime($insp['fecha_capacitacion'])) ?>
                            <?php if (!empty($insp['nombre_capacitacion'])): ?>
                                &middot; <?= esc($insp['nombre_capacitacion']) ?>
                            <?php endif; ?>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            html: 'Se eliminara el reporte de <strong>' + btn.dataset.nombre + '</strong>',
            icon: 'warning',
