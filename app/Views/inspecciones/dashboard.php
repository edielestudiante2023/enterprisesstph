    ...
    */ ?>
    ...
    <div class="card mb-3 border-0" style="background: linear-gradient(135deg, #F6C87E 0%, #E5A24F 100%); border-radius: 12px; padding: 14px 10px 10px;">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:8px;">
            ...
            <a href="<?= base_url('/inspecciones/zona-bbq') ?>" style="padding:12px 6px; margin:0; border-radius:10px; background:rgba(255,255,255,0.55); text-align:center; text-decoration:none; transition:transform .2s;">
                ...
                <div style="font-size:11px; color:rgba(107,62,18,0.7);">(<?= $totalZonaBbq ?? 0 ?>)</div>
            </a>
        </div>
    </div>
