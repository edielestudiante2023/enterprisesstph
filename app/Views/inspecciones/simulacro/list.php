...
document.addEventListener('DOMContentLoaded',function(){
    ...
    $('#tablaInsp').on('click','.btn-del',function(){
        ...
        Swal.fire({title:'¿Eliminar evaluación?',html:'Se eliminará la evaluación de <strong>'+n+'</strong>',icon:'warning',showCancelButton:true,confirmButtonColor:'#dc3545',confirmButtonText:'Sí, eliminar',cancelButtonText:'Cancelar'})
