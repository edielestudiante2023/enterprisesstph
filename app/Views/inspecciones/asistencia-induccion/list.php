...
$(function(){
    ...
    $('#tablaInsp').on('click','.btn-del',function(){
        ...
        Swal.fire({title:'¿Eliminar registro?',html:'Se eliminará la asistencia de <strong>'+n+'</strong>',icon:'warning',showCancelButton:true,confirmButtonColor:'#dc3545',confirmButtonText:'Sí, eliminar',cancelButtonText:'Cancelar'})
