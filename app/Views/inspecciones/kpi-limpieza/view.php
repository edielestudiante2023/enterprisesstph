...
<a href="/inspecciones/kpi-limpieza/pdf/<?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-primary mb-4" target="_blank">
...
<?php endif; ?>
    ...
    <a href="/inspecciones/kpi-limpieza/enviar-email/<?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-outline" onclick="return confirm('¿Enviar el PDF por email al cliente, consultor y consultor externo?')">
