<div class="container-fluid px-3">
    ...
    <!-- Boton nueva -->
    <a href="/inspecciones/recursos-seguridad/create" class="btn btn-pwa btn-pwa-primary mb-3">
            ...
            <div class="card-body py-2 px-3">
                ...
                <div class="mt-2 d-flex gap-1 flex-wrap">
                    <?php if ($insp['estado'] === 'borrador'): ?>
                        <a href="/inspecciones/recursos-seguridad/edit/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                    ...
                    <?php else: ?>
                        <a href="/inspecciones/recursos-seguridad/view/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                            <i class="fas fa-eye"></i> Ver
                        </a>
                        <a href="/inspecciones/recursos-seguridad/pdf/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-primary" target="_blank">
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/inspecciones/recursos-seguridad/delete/' + btn.dataset.id;
            }
        });
    });
});
