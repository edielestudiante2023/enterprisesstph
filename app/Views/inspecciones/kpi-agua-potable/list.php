...
<a href="/inspecciones/kpi-agua-potable/create" class="btn btn-pwa btn-pwa-primary mb-3">
        ...
        <div class="card-body py-3 px-3">
            ...
            <div class="mt-2 d-flex gap-2">
                <?php if ($insp['estado'] === 'borrador'): ?>
                    <a href="/inspecciones/kpi-agua-potable/edit/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                ...
                <?php else: ?>
                    <a href="/inspecciones/kpi-agua-potable/view/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                        <i class="fas fa-eye"></i> Ver
                    </a>
                    <a href="/inspecciones/kpi-agua-potable/pdf/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-primary" target="_blank">
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/inspecciones/kpi-agua-potable/delete/' + btn.dataset.id;
            }
        });
    });
});
