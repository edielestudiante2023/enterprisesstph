...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0"><i class="fas fa-bug me-2"></i>Control Integrado de Plagas</h5>
</div>
...
<div class="d-flex gap-2 mb-3">
    <a href="<?= base_url('/inspecciones/control-plagas/create') ?>" class="btn btn-pwa btn-pwa-primary flex-fill">
        <i class="fas fa-plus me-2"></i>Nuevo Programa
    </a>
    <a href="<?= base_url('/inspecciones/control-plagas/documento') ?>" class="btn btn-pwa btn-pwa-outline" target="_blank" title="Texto completo del documento">
        <i class="fas fa-file-alt me-1"></i> Documento
    </a>
    <a href="<?= base_url('/inspecciones/control-plagas/presentacion') ?>" class="btn btn-pwa btn-pwa-outline" target="_blank" title="Estructura con candidatos IA">
    ...
    <div class="card card-inspeccion mb-2 card-filtrable" data-cliente="<?= esc($insp['nombre_cliente'] ?? '') ?>">
        <div class="card-body py-3 px-3">
            ...
            <div class="mt-2 d-flex gap-2">
                    <a href="<?= base_url('/inspecciones/control-plagas/edit/') ?><?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                ...
                <?php if ($insp['estado'] === 'completo'): ?>
                    <a href="<?= base_url('/inspecciones/control-plagas/view/') ?><?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                        <i class="fas fa-eye"></i> Ver
                    </a>
                    <a href="<?= base_url('/inspecciones/control-plagas/pdf/') ?><?= $insp['id'] ?>" class="btn btn-sm btn-outline-primary" target="_blank">
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '<?= base_url('/inspecciones/control-plagas/delete/') ?>' + id;
            }
        });
    });
});
