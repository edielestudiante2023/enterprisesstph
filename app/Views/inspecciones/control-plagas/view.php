...
<div class="d-grid gap-2 mb-4">
    ...
    <a href="/inspecciones/control-plagas/pdf/<?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-primary" target="_blank">
    ...
    <a href="/inspecciones/control-plagas/enviar-email/<?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-outline" onclick="return confirm('¿Enviar el PDF por email al cliente, consultor y consultor externo?')">
    ...
    <?php endif; ?>
    <a href="/inspecciones/control-plagas" class="btn btn-pwa btn-pwa-outline">
