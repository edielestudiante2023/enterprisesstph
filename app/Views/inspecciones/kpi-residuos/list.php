...
<a href="/inspecciones/kpi-residuos/create" class="btn btn-pwa btn-pwa-primary mb-3">
        ...
        <div class="card-body py-3 px-3">
            ...
            <div class="mt-2 d-flex gap-2">
                ...
                <?php else: ?>
                    ...
                    <a href="/inspecciones/kpi-residuos/pdf/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-primary" target="_blank">
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/inspecciones/kpi-residuos/delete/' + btn.dataset.id;
            }
        });
    });
});
