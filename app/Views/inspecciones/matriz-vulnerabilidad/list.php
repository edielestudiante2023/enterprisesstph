<div class="container-fluid px-3">
    ...
    <!-- Boton nueva -->
    <a href="/inspecciones/matriz-vulnerabilidad/create" class="btn btn-pwa btn-pwa-primary mb-3">
            ...
            <div class="card-body py-2 px-3">
                ...
                <div class="mt-2 d-flex gap-1 flex-wrap">
                    <?php if ($insp['estado'] === 'borrador'): ?>
                        <a href="/inspecciones/matriz-vulnerabilidad/edit/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                    ...
                    <?php else: ?>
                        <a href="/inspecciones/matriz-vulnerabilidad/view/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-dark">
                            <i class="fas fa-eye"></i> Ver
                        </a>
                        <a href="/inspecciones/matriz-vulnerabilidad/pdf/<?= $insp['id'] ?>" class="btn btn-sm btn-outline-primary" target="_blank">
    ...
    document.addEventListener('click', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/inspecciones/matriz-vulnerabilidad/delete/' + btn.dataset.id;
            }
        });
    });
});
