...
class GimnasioDetalleEvidenciaModel extends Model
{
    protected $table = 'tbl_gimnasio_detalle_evidencia';
    ...
    /** Devuelve array indexado por slot (1..6), null si slot vacio. */
